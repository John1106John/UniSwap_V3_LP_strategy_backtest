...
def chart1(dpd,base,myliquidity,hold_V,price0):
    ...
    final1["hold_compare_change"].iloc[0] = final1["hold_value_compare"].iloc[0] - V
    ...
    final1["value"] = final1["amountVlast"] + final1["cumulative_feeV"]
    position_return = final1["value"][-1] / final1['amountV'][0] -1 
    #final1.to_csv("chart1.csv", sep=";")

    important_sheet=final1[["close"]].copy() 
    important_sheet[['pair_value',"total_value","hold_value_compare","hold_strategy_value","amount0","amount1","cumulative_feeV","PNL","IL_change"]]=\
        final1[['amountVlast',"value","hold_value_compare","hold_value","amount0","amount1","cumulative_feeV","hold_compare_change","IL_change"]]
